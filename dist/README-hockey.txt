...
following:
     ...
     subsequent redistribution. (However, it is okay to modify the
     font files in any way for your own personal use.)
...
However, you have permission to do the following: 
  ...
  Make commercial products like T-shirts or Mugs or Books using the
    ...
    write me an e-mail (below) and let me know where the
    font is being used.
...
may be included on any recognized distribution of the Linux and
(Open/Net/Free)BSD operating systems, even if the CD is sold. Please
include this README file.


My e-mail address is: tom7 (a) (same as the username).org
You can use this to get my current real-world address for sending
me things!
